...
var charID = 0; //defines the chosen character 
...
{ 
    //  Arrow Button Function - changes character numbers stepwise form 1 to 3 (or 4 to 6) in both directions (1 -> 2 -> 3 -> 1 and 3 -> 2 -> 1 -> 3)
    var img = document.getElementById("chosenCharacterGraphic");
    if(gender == 0){
        if(x == 1){
